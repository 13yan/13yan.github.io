"""追加 8/26 抖店数据（巨兽战场直播日）—— 自营已按用户修正为 15,884"""
...
# ===== CSV 8/26 原始数据（自营修正：12,534 → 15,884，用户确认） =====
# 2026/8/26,巨兽战场,10936,726,19,27,57,1625,4,7.14min,16,026,15,884,71,724,116,25866,6044,28,12
RAW = ['2026/8/26', '巨兽战场', '10936', '726', '19', '27', '57', '1625', '4', '7.14min', '16026', '15884', '71', '724', '116', '25866', '6044', '28', '12']
...
data['updatedAt'] = now
data['_meta']['lastWrite'] = '2026-08-27'
data['_meta']['lastUpdate'] = {
    'csv': '桌面抖店数据_0716.csv',
    'dates': '8/26',
    'note': f"增量追加1天(8/26直播: 自播16,026+自营15,884(修正)=¥31,910; 安卓25,866/28人+iOS6,044/12人; 订单71); totalGMV=809,984"
}

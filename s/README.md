...
## 当前数据快照（2026-08-18 更新）

来源：`E:\抖店数据_2026-07-02~2026-08-02.csv` + 8 月逐日 CSV/手动贴入
- **47 天数据（7/02~8/17）**
- 总GMV：¥472,160（直播 ¥230,870 + 自营 ¥241,290）
- 直播GMV：¥230,870
- 自营GMV：¥241,290
- 订单 653 / 付费用户 388 / 安卓占比 52.5%（健康）
- 预估利润：¥360,730.24（利润率 76.4%）

### 更新记录

| 日期 | 内容 | 结果 |
|---|---|---|
| 2026-08-18 | 追加 8/17 巨兽战场直播日（直播31,722 + 自营34,290 = ¥66,012 单日新高；安卓22,564/13人 + iOS43,448/19人；订单71） | 47场，GMV 406,148→472,160，订单 582→653 |

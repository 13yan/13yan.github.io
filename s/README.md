...
## 当前数据快照（2026-08-20 更新）

来源：`E:\抖店数据_2026-07-02~2026-08-02.csv` + 8 月逐日 CSV/手动贴入
- **49 天数据（7/02~8/19）**
- 总GMV：¥552,580（直播 ¥303,626 + 自营 ¥248,954）
- 直播GMV：¥303,626
- 自营GMV：¥248,954
- 订单 761 / 付费用户 437 / 安卓占比 57.0%（健康）
- 预估利润：¥422,171.12（利润率 76.4%）

### 更新记录

| 日期 | 内容 | 结果 |
|---|---|---|
| 2026-08-20 | 追加 8/19 巨兽战场直播日（直播31,586 + 自营388 = ¥31,974；安卓31,246/14人 + iOS728/6人；订单38） | 49场，GMV 520,606→552,580，订单 723→761 |

...
## 当前数据快照（2026-08-19 更新）

来源：`E:\抖店数据_2026-07-02~2026-08-02.csv` + 8 月逐日 CSV/手动贴入
- **48 天数据（7/02~8/18）**
- 总GMV：¥520,606（直播 ¥272,040 + 自营 ¥248,566）
- 直播GMV：¥272,040
- 自营GMV：¥248,566
- 订单 723 / 付费用户 417 / 安卓占比 54.5%（健康）
- 预估利润：¥397,742.98（利润率 76.4%）

### 更新记录

| 日期 | 内容 | 结果 |
|---|---|---|
| 2026-08-19 | 追加 8/18 巨兽战场直播日（直播41,170 + 自营7,276 = ¥48,446；安卓35,572/17人 + iOS12,874/12人；订单70） | 48场，GMV 472,160→520,606，订单 653→723 |

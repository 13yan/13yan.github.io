...
## 当前数据快照（2026-08-25 更新）

来源：`E:\抖店数据_2026-07-02~2026-08-02.csv` + 8 月逐日 CSV/手动贴入
- **54 天数据（7/02~8/24）**
- 总GMV：¥695,102（直播 ¥424,906 + 自营 ¥270,196）
- 直播GMV：¥424,906
- 自营GMV：¥270,196
- 订单 1,037 / 付费用户 588 / 安卓占比 60.0%（健康，已逼近 60% 临界线）
- 预估利润：¥531,057.93（利润率 76.4%）

### 更新记录

| 日期 | 内容 | 结果 |
|---|---|---|
| 2026-08-25 | 追加 8/21~8/24 四天（8/21:25,588；8/22:35,400；8/23:51,694；8/24无直播:7,994 = ¥120,676；安卓88,632 + iOS32,044） | 54场，GMV 574,426→695,102，订单 802→1,037 |

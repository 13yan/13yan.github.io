...
## 当前数据快照（2026-08-21 更新）

来源：`E:\抖店数据_2026-07-02~2026-08-02.csv` + 8 月逐日 CSV/手动贴入
- **50 天数据（7/02~8/20）**
- 总GMV：¥574,426（直播 ¥324,456 + 自营 ¥249,970）
- 直播GMV：¥324,456
- 自营GMV：¥249,970
- 订单 802 / 付费用户 462 / 安卓占比 57.2%（健康）
- 预估利润：¥438,861.46（利润率 76.4%）

### 更新记录

| 日期 | 内容 | 结果 |
|---|---|---|
| 2026-08-21 | 追加 8/20 巨兽战场直播日（直播20,830 + 自营1,016 = ¥21,846；安卓13,504/16人 + iOS8,342/9人；订单41） | 50场，GMV 552,580→574,426，订单 761→802 |

...
## 当前数据快照（2026-08-27 更新）

来源：`E:\抖店数据_2026-07-02~2026-08-02.csv` + 8 月逐日 CSV/手动贴入
- **56 天数据（7/02~8/26）**
- 总GMV：¥809,984（直播 ¥484,172 + 自营 ¥325,812）
- 直播GMV：¥484,172
- 自营GMV：¥325,812
- 订单 1,195 / 付费用户 678 / 安卓占比 60.5%（🟡 中度风险，已突破 60% 临界线）
- 预估利润：¥618,827.78（利润率 76.4%）

### 更新记录

| 日期 | 内容 | 结果 |
|---|---|---|
| 2026-08-27 | 追加 8/26 巨兽战场直播日（自播16,026 + 自营15,884（用户修正）= ¥31,910；安卓25,866/28人 + iOS6,044/12人；订单71） | 56场，GMV 778,074→809,984，订单 1,124→1,195 |

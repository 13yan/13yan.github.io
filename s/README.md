...
- **75 天数据（7/02~9/17）**
- 总GMV：¥1,412,164（直播 ¥852,738 + 自营 ¥559,426）
- 直播GMV：¥852,738
- 自营GMV：¥559,426
- 订单 2,455 / 付费用户 1,835 / 安卓占比 64.4%（🟡 中度风险）
- 预估利润：¥1,078,893.30（利润率 76.4%）

### 更新记录

| 日期 | 内容 | 结果 |
|---|---|---|
| 2026-09-18 | 追加 4 天（09/14(无直播):35,362+13,316=48,678；09/15(无直播):15,316+18,164=33,480；09/16(无直播):12,334+9,914=22,248；09/17(无直播):8,724+6,882=15,606 = ¥120,012） | 71场→75场，GMV 1,292,152→1,412,164，订单 2,125→2,455 |

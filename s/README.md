...
## 当前数据快照（2026-09-01 更新）

来源：`E:\抖店数据_2026-07-02~2026-08-02.csv` + 8 月逐日 CSV/手动贴入
- **61 天数据（7/02~8/31）**
- 总GMV：¥1,168,850（直播 ¥705,916 + 自营 ¥462,934）
- 直播GMV：¥705,916
- 自营GMV：¥462,934
- 订单 1,724 / 付费用户 946 / 安卓占比 62.6%（🟡 中度风险，继续上行）
- 预估利润：¥893,001.40（利润率 76.4%）

### 更新记录

| 日期 | 内容 | 结果 |
|---|---|---|
| 2026-09-01 | 追加 8/31 巨兽战场（无直播日：直播56,060 + 自营61,766 = ¥117,826 单日新高；安卓90,716/53人 + iOS27,110/27人；订单208） | 61场，GMV 1,051,024→1,168,850，订单 1,516→1,724 |

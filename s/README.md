...
## 当前数据快照（2026-08-31 更新）

来源：`E:\抖店数据_2026-07-02~2026-08-02.csv` + 8 月逐日 CSV/手动贴入
- **60 天数据（7/02~8/30）**
- 总GMV：¥1,051,024（直播 ¥649,856 + 自营 ¥401,168）
- 直播GMV：¥649,856
- 自营GMV：¥401,168
- 订单 1,516 / 付费用户 866 / 安卓占比 60.9%（🟡 中度风险，再次突破 60% 临界线）
- 预估利润：¥802,982.34（利润率 76.4%）

### 更新记录

| 日期 | 内容 | 结果 |
|---|---|---|
| 2026-08-31 | 追加 8/28~8/30 三天（8/28:47,710；8/29:59,982；8/30:84,146 = ¥191,838；其中 8/29 安卓占比 80.9% 高度风险） | 60场，GMV 859,186→1,051,024，订单 1,260→1,516 |

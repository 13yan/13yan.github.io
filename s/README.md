...
## 当前数据快照（2026-08-26 更新）

来源：`E:\抖店数据_2026-07-02~2026-08-02.csv` + 8 月逐日 CSV/手动贴入
- **55 天数据（7/02~8/25）**
- 总GMV：¥778,074（直播 ¥468,146 + 自营 ¥309,928）
- 直播GMV：¥468,146
- 自营GMV：¥309,928
- 订单 1,124 / 付费用户 638 / 安卓占比 59.6%（健康，逼近 60% 临界线）
- 预估利润：¥594,448.54（利润率 76.4%）

### 更新记录

| 日期 | 内容 | 结果 |
|---|---|---|
| 2026-08-26 | 追加 8/25 巨兽战场直播日（直播43,240 + 自营39,732 = ¥82,972；安卓46,854/24人 + iOS36,118/26人；订单87） | 55场，GMV 695,102→778,074，订单 1,037→1,124 |

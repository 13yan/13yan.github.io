...
## 当前数据快照（2026-09-11 更新）

来源：`E:\抖店数据_2026-07-02~2026-08-02.csv` + 8 月逐日 CSV/手动贴入
- **71 天数据（7/02~9/10）**
- 总GMV：¥1,292,152（直播 ¥781,002 + 自营 ¥511,150）
- 直播GMV：¥781,002
- 自营GMV：¥511,150
- 订单 2,125 / 付费用户 1,177 / 安卓占比 63.3%（🟡 中度风险）
- 预估利润：¥987,204.13（利润率 76.4%）

### 更新记录

| 日期 | 内容 | 结果 |
|---|---|---|
| 2026-09-11 | 追加 4 天（09/07(无直播):4,082+7,654=11,736；09/08(无直播):678+8,616=9,294；09/09(无直播):9,906+6,292=16,198；09/10(无直播):10,878+4,580=15,458 = ¥52,686） | 67场→71场，GMV 1,239,466→1,292,152，订单 1,999→2,125 |
| 2026-09-07 | 追加 5 天（09/02:4,662+1,932=6,594；09/03:6,298+3,706=10,004；09/04(无直播):5,136+4,310=9,446；09/05(无直播):13,884+4,494=18,378；09/06(无直播):8,414+1,672=10,086 = ¥54,508） | 62场→67场，GMV 1,184,958→1,239,466，订单 1,759→1,999 |
| 2026-09-02 | 追加 9/1 巨兽战场直播日（直播11,148 + 自营4,960 = ¥16,108；安卓14,078/12人 + iOS2,030/9人；订单35） | 62场，GMV 1,168,850→1,184,958，订单 1,724→1,759 |
